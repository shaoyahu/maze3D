...
describe('generateKruskal', () => {
  it('returns a 2D array of 0/1 cells of the right shape', () => {
    const walls = generateKruskal(15, mulberry32(1));
