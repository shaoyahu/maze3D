...
| 字段 | 值 |
|---|---|
| 活跃增量 | **P4b-Panorama 3D 全景 minimap(2026-08-07 session 实施;120×120 容器拆 3 strip × 40px 堆叠(上 walls3D[y+1] 50% opacity + 中 walls3D[y] 满色 + 下 walls3D[y-1] 50% opacity);越界 strip 不渲染(currentLayer=0 没下层 / =visualSize-1 没上层,留白);1px 灰 border-bottom 分隔线;YStrip 组件 React.memo 接受 walls2D + opacity + isCurrent + exitPos + visitedForLevel + exitHint;玩家 arrow / cone / visited / 出口 rect 只在当前 y strip;off-layer "↑/↓ exit" 复用 P4b-Minimap dispatch;复用 getPlayerY() + PlayerSnapshot.y + Y_EPSILON + onLevelChange(yCell) 全部前 scope 锁;typecheck 0/vitest 1749 pass+1 skip;待用户 commit)** |
| 已完成 | P2-2 14/14 ✅ + P2-3 14/14 ✅ + P2-4a 16/16 ✅ + P2-4b 20/20 ✅ + P2-5 16/16 ✅ + P2-6 10/10 ✅ + P2-7 8/8 ✅ + P2-9 ✅ + P2-10 11/11 ✅ + P2-11 16/16 ✅ + P2-13 ✅ + P2-14 ✅ + P2-15 24/24 ✅ + P2-16 ✅ + P2-17 ✅ + P2-18 ✅ + P2-19 ✅ + P2-20 ✅ + P2-21 ✅ + P3-1 ✅ + P3-2 ✅ + P3-3 ✅ + P4a ✅ + P4b-Prim ✅ + P4b-CellSize ✅ + P4b-Lerp ✅ + P4b-Minimap ✅ + P4b-HudLayer ✅ + **P4b-Panorama ✅ (2026-08-07, session 实施;2 文件/+9 case)** |
| 下一个任务 | P4 路线图全部 ship 闭环 (P4a/P4b-Prim/P4b-CellSize/P4b-Lerp/P4b-Minimap/P4b-HudLayer/P4b-Panorama);后续候选 — 3D enemy AI / 3D editor / 3D tutorial / InstancedMesh / octree culling / HUD chip total "L5/15" |
| 最后更新 | 2026-08-07 |
| 最近 commit | 待提交 — P4b-HudLayer HUD LevelIndicator 2D/3D dispatch (5a13a78) 已 push;P4b-Panorama 增量在 working tree 等待用户 commit |
