...
| 字段 | 值 |
|---|---|
| 活跃增量 | **P4b-Minimap 3D top-down minimap(2026-08-07 session 实施;is3D dispatch on walls3D + 渲染 walls3D[currentLayer] 当前 y-layer 2D 顶视图 + Game.getPlayerY() accessor + tick3DTween 完成时 recordVisit 写 parchment.visitedCells.get(yCell) + PlayerSnapshot 加 y 字段 + Y_EPSILON 早出 + 3D exit dispatch (同层 COLOR_EXIT rect / off-layer "↑/↓ exit" SVG text) + "L{n}/{total}" 标签;StaticMaze 重构接受 walls2D + exitPos + pickups props 跟 2D 复用;typecheck 0/vitest 1738 pass+1 skip;待用户 commit)** |
| 已完成 | P2-2 14/14 ✅ + P2-3 14/14 ✅ + P2-4a 16/16 ✅ + P2-4b 20/20 ✅ + P2-5 16/16 ✅ + P2-6 10/10 ✅ + P2-7 8/8 ✅ + P2-9 ✅ + P2-10 11/11 ✅ + P2-11 16/16 ✅ + P2-13 ✅ + P2-14 ✅ + P2-15 24/24 ✅ + P2-16 ✅ + P2-17 ✅ + P2-18 ✅ + P2-19 ✅ + P2-20 ✅ + P2-21 ✅ + P3-1 ✅ + P3-2 ✅ + P3-3 ✅ + P4a ✅ + P4b-Prim ✅ + P4b-CellSize ✅ + P4b-Lerp ✅ + **P4b-Minimap ✅ (2026-08-07, session 实施;4 文件/+10 case)** |
| 下一个任务 | P4 路线图全部 ship 闭环 (P4a/P4b-Prim/P4b-CellSize/P4b-Lerp/P4b-Minimap);后续候选 — 3D enemy AI / 3D editor / 3D tutorial / InstancedMesh / octree culling / HUD LevelIndicator dispatch 2D/3D |
| 最后更新 | 2026-08-07 |
| 最近 commit | 待提交 — P4b-Lerp 3D Player 0.1s tween (2d9d1b0) 已 push;P4b-Minimap 增量在 working tree 等待用户 commit |
