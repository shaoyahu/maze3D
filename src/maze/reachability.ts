...
// (P4 3D BFS removed in P0-followup; 3D voxel maze support retired in
// P4-refactor-fp2d. P3-1's stacked-layer multi-level shape
// (`isReachableMultiLevel` above) is the only multi-dim reachability
