...
const COLOR_PICKUP = 'rgba(255, 184, 77, 0.95)';
...
// 1300×269 viewport aspect distortion, which we ignore for visual clarity).
const CONE_LENGTH = 2;
...
// React.memo skips its reconciliation on every tick so a 50×50 maze doesn't
...
// GameCanvas and everything inside it 60× per second). The minimap
